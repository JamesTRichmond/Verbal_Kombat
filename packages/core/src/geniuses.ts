...
export const GENIUSES: Genius[] = [
  ...
  { slug: "marilyn-vos-savant", name: "Marilyn vos Savant", wing: "questioners", method: "Spell out every equally likely case, exaggerate the setup, and let the tally beat intuition." },
  ...
  { slug: "yang-chen-ning", name: "Chen-Ning Yang", wing: "lawfinders", method: "Start from the symmetry, derive the structure it forces, and test the assumptions nobody tested." },
  { slug: "edward-witten", name: "Edward Witten", wing: "lawfinders", method: "Find a deformation-proof quantity or dual description, compute where it's easy, and carry the answer back." },
  ...
  { slug: "christopher-michael-langan", name: "Christopher Langan", wing: "pattern_seers", method: "Demand that any model include its observer, generate its own rules, and close its self-reference loops.", contested: true },
  ...
  { slug: "daniel-afedzi-akyeampong", name: "Daniel Afedzi Akyeampong", wing: "pattern_seers", method: "When a calculation blows up, embed it in a tunable family, then track which symmetries break." },
  ...
  { slug: "grigori-perelman", name: "Grigori Perelman", wing: "pattern_seers", method: "Let the system smooth itself, track a quantity that only improves, and operate where it pinches." },
  ...
  { slug: "shing-tung-yau", name: "Shing-Tung Yau", wing: "pattern_seers", method: "Try to disprove the conjecture, then bound every possible solution and deform from a known case." },
  ...
  { slug: "terence-chi-shen-tao", name: "Terence Tao", wing: "pattern_seers", method: "Split the problem into structured and random parts, solve toy versions, and verify every piece." },
  ...
  { slug: "donald-knuth", name: "Donald Knuth", wing: "formalizers", method: "Analyze algorithms exactly, optimize only measured hot spots, and write code as essays for people." },
  ...
  { slug: "bennet-ifeakandu-omalu", name: "Bennet Omalu", wing: "experimenters", method: "When the surface looks normal but the history does not, look deeper and follow the evidence." },
  ...
  { slug: "christopher-michael-hirata", name: "Christopher Hirata", wing: "experimenters", method: "Chase the subtle biases standard checks miss, including cross-terms and neglected effects, until errors are budgeted." },
  ...
  { slug: "gladys-brown-west", name: "Gladys West", wing: "experimenters", method: "Model messy reality's true shape, correcting for every force that bends the data." },
  ...
  { slug: "jane-goodall", name: "Jane Goodall", wing: "experimenters", method: "Watch patiently for years, know each individual, and let what you see overturn fond beliefs." },
  { slug: "jocelyn-bell-burnell", name: "Jocelyn Bell Burnell", wing: "experimenters", method: "Know the usual signals and noise so well that anything else stands out, then test it." },
  ...
  { slug: "segenet-kelemu", name: "Segenet Kelemu", wing: "experimenters", method: "Find the unseen partners behind resilience, prove their effect cleanly, then build institutions to scale it." },
  ...
  { slug: "venkatraman-ramakrishnan", name: "Venkatraman Ramakrishnan", wing: "experimenters", method: "Switch fields to reach the central problem, then see the machine working in atomic detail." },
  ...
  { slug: "demis-hassabis", name: "Demis Hassabis", wing: "imaginers", method: "Choose problems whose solution unlocks whole fields, then attack them with search guided by learned models." },
  ...
  { slug: "ilya-sutskever", name: "Ilya Sutskever", wing: "imaginers", method: "Trust simple learning at scale, recast tasks as prediction, and study where models generalize poorly." },
  ...
  { slug: "kip-thorne", name: "Kip Thorne", wing: "imaginers", method: "Label every idea as truth, educated guess, or speculation, then pursue bold goals inside physical law." },
  ...
  { slug: "roger-penrose", name: "Roger Penrose", wing: "imaginers", method: "Draw the whole geometry, find arguments that survive messiness, and check local fits for global impossibility." },
  ...
  { slug: "bjarne-stroustrup", name: "Bjarne Stroustrup", wing: "builders", method: "Add abstractions that cost nothing unused, tie resources to lifetimes, and evolve without stranding users." },
  ...
  { slug: "john-carmack", name: "John Carmack", wing: "builders", method: "Find the constraint that matters, study the research, build it yourself, measure, and publish the notes." },
  { slug: "linus-torvalds", name: "Linus Torvalds", wing: "builders", method: "Judge by working code, fix the data structures, never break users, and scale trust through maintainers." },
  { slug: "margaret-hamilton", name: "Margaret Hamilton", wing: "builders", method: "Assume the impossible failure will occur, rank every task, and build recovery in before launch." },
  { slug: "nashwa-abo-alhassan-eassa", name: "Nashwa Abo Alhassan Eassa", wing: "builders", method: "Treat the thin layer that spoils performance, then aim affordable materials at local needs." },
  ...
  { slug: "philip-emeagwali", name: "Philip Emeagwali", wing: "builders", method: "Return to the full equations and recast them so many simple processors solve them cheaply." },
  ...
  { slug: "tim-berners-lee", name: "Tim Berners-Lee", wing: "builders", method: "Give everything a universal name, let anyone link without permission, and keep the standards open." },
  ...
  { slug: "garry-kimovich-kasparov", name: "Garry Kasparov", wing: "strategists", method: "Prepare deeper than anyone, then trade material for time so the opponent is always reacting." },
  ...
  { slug: "judit-polgar", name: "Judit Polgár", wing: "strategists", method: "Skip the separate league, measure yourself against the strongest field, and attack fearlessly with drilled tactics." },
  { slug: "magnus-carlsen", name: "Magnus Carlsen", wing: "strategists", method: "Take a playable equal position, keep the game going, and press until the opponent cracks." },
  ...
  { slug: "evangelos-katsioulis", name: "Evangelos Katsioulis", wing: "mind_mappers", method: "Profile abilities by field and level, then build forums where original ideas meet real critique." },
  { slug: "geoffrey-hinton", name: "Geoffrey Hinton", wing: "mind_mappers", method: "Trust learning over hand-built rules, follow the error gradient, and inspect what the network learned." },
  ...
  { slug: "john-hopfield", name: "John Hopfield", wing: "mind_mappers", method: "Hunt paradoxes between theory and data, then model the system as dynamics rolling downhill into answers." },
  ...
  { slug: "noam-chomsky", name: "Noam Chomsky", wing: "mind_mappers", method: "Seek rules generating all and only valid cases, then ask which filters shaped the news." },
  ...
  { slug: "terrence-deacon", name: "Terrence Deacon", wing: "mind_mappers", method: "Explain purpose and meaning through constraints, what is absent, and self-maintaining coupled processes." },
  ...
  { slug: "yann-lecun", name: "Yann LeCun", wing: "mind_mappers", method: "Build the data's structure into the architecture, learn mostly from observation, and predict abstract states." },
  ...
  { slug: "eckhart-tolle", name: "Eckhart Tolle", wing: "awakeners", method: "Step back from compulsive thinking into present awareness, accept this moment, then act from there." },
  ...
  { slug: "kim-ung-yong", name: "Kim Ung-yong", wing: "awakeners", method: "Refuse borrowed scoreboards; choose ordinary, sustainable work that makes you content, and let labels fall." },
  ...
  { slug: "richard-lang", name: "Richard Lang", wing: "awakeners", method: "Make the experiments quick, playful tests anyone can share, then carry seeing into ordinary life." },
  ...
  { slug: "amartya-kumar-sen", name: "Amartya Sen", wing: "society_shapers", method: "Judge outcomes by people's real capabilities and entitlements, and compare feasible options through open public reasoning." },
  { slug: "andrew-yang", name: "Andrew Yang", wing: "society_shapers", method: "Trace how automation reshapes work, put numbers on the human impact, then test cross-partisan systemic fixes." },
  ...
  { slug: "tshilidzi-marwala", name: "Tshilidzi Marwala", wing: "society_shapers", method: "Use AI to fill missing information and steady inconsistent judgment, then govern the tradeoffs it creates." },
